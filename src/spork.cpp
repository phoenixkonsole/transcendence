...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_LOWERED_MASTERNODE_PAYMENT) r = SPORK_18_LOWERED_MASTERNODE_PAYMENT_DEFAULT;
        if (nSporkID == SPORK_19_REWARD_HALVING_START) r = SPORK_19_REWARD_HALVING_START_DEFAULT;
