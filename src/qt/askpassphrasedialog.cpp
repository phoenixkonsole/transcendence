                                                                                           ...
                                                                                           fCapsLock(false)
{
    ...
    ui->passEdit1->setMaxLength(MAX_PASSTELOSASE_SIZE);
    ui->passEdit2->setMaxLength(MAX_PASSTELOSASE_SIZE);
    ui->passEdit3->setMaxLength(MAX_PASSTELOSASE_SIZE);
...
void AskPassphraseDialog::accept()
{
    ...
    if (!model)
        return;
    oldpass.reserve(MAX_PASSTELOSASE_SIZE);
    newpass1.reserve(MAX_PASSTELOSASE_SIZE);
    newpass2.reserve(MAX_PASSTELOSASE_SIZE);
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Transcendence will close now to finish the encryption process. "
                               ...
                               "your TELOSs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
