...
/** 
    ...
    ****Note - for Transcendence we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of transcendence coming in to a transaction
