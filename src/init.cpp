...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the TELOSIPCOIN and zTELOS money supply statistics") + " " + _("on startup"));
    ...
    if (GetBoolArg("-help-debug", false))
        strUsage += HelpMessageOpt("-mintxfee=<amt>", strprintf(_("Fees (in TELOSIPCOIN/Kb) smaller than this are considered zero fee for transaction creation (default: %s)"),
            FormatMoney(CWallet::minTxFee.GetFeePerK())));
    strUsage += HelpMessageOpt("-paytxfee=<amt>", strprintf(_("Fee (in TELOSIPCOIN/kB) to add to transactions you send (default: %s)"), FormatMoney(payTxFee.GetFeePerK())));
    ...
    strUsage += HelpMessageOpt("-minrelaytxfee=<amt>", strprintf(_("Fees (in TELOSIPCOIN/Kb) smaller than this are considered zero fee for relaying (default: %s)"), FormatMoney(::minRelayTxFee.GetFeePerK())));
...
//    strUsage += "  -anonymizetranscendenceamount=<n>     " + strprintf(_("Keep N TELOSIPCOIN anonymized (default: %u)"), 0) + "\n";
...
//    if (nAnonymizeTranscendenceAmount < 2) nAnonymizeTranscendenceAmount = 2;
    ...
    /* Denominations
       ...
       For example:
       1TELOSIPCOIN+1000 == (.1TELOSIPCOIN+100)*10
       10TELOSIPCOIN+10000 == (1TELOSIPCOIN+1000)*10
    */
