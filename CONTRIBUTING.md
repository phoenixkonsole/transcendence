Contributing to Transcendence Core
============================

The Transcendence Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Transcendence Core project, and is not to be
confused with overall Transcendence Network Protocol consensus changes.

Whether a pull request is merged into Transcendence Core rests with the project merge
...
Patches that change Transcendence consensus rules are considerably more involved than
...
Where a patch set proposes to change the Transcendence consensus, it must have been
...
The project leader is the release manager for each Transcendence Core release.
