...
public:
    ...
    void setZTranscendenceControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTELOS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTELOS_clicked();
    void on_pushButtonZTranscendenceControl_clicked();
