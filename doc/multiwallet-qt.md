...
In order to support loading of multiple wallets in transcendence-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is transcendence.cpp.
...
Changes to transcendence.cpp
----------------------
transcendence.cpp is the entry point into transcendence-qt, and as such, will require some minor modifications to provide hooks for
