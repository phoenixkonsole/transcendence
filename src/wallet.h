...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 TELOS at the same time
...
enum ZerocoinSpendStatus {
    ZTELOS_SPEND_OKAY = 0,                            // No error
    ZTELOS_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZTELOS_WALLET_LOCKED = 2,                         // Wallet was locked
    ZTELOS_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZTELOS_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZTELOS_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZTELOS_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZTELOS_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZTELOS_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZTELOS_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZTELOS_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZTELOS_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZTELOS_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZTELOS_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZTELOS_SPENT_USED_ZTELOS = 14                       // Coin has already been spend
};
