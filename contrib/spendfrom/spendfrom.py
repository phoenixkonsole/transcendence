#!/usr/bin/env python
#
# Use the raw transactions API to spend TELOSIPCOINs received on particular addresses,
...
def main():
    ...
    parser.add_option("--from", dest="fromaddresses", default=None,
                      help="addresses to get TELOSIPCOINs from")
    parser.add_option("--to", dest="to", default=None,
                      help="address to get send TELOSIPCOINs to")
