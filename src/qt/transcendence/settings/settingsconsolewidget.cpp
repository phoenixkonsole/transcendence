...
#include "qt/transcendence/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/transcendence/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the Transcendence RPC console.") + "<br>" +
